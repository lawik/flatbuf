...
%{
  "alignment_test" =>
    {:error, :flatc,
     {:flatc_failed,
      "\nerror:\n  /tmp/flatbuf_oracle_17667/input.json:2: 22: error: unknown field: small_structs\n\n"}},
  "annotated_binary" => {:error, :mismatch, {:keys_diff, [], [], ["foobars_type", "maybe_i32"]}},
  "evolution_v1" => {:error, :flatc, {:flatc_no_json, ""}},
  "evolution_v2" => {:error, :mismatch, {:value_diff, ["e", "a"], 3.14520001411438, 3.1452}},
  "monsterdata_cstest" => :ok,
  "monsterdata_cstest_sp" => :ok,
  "monsterdata_extra" => {:error, :decode, "{:error, {:badmatch, <<0, ...>>}}"},
  ...
  "optional_scalars" =>
    {:error, :mismatch,
     {:keys_diff, [], [],
      ["maybe_bool", "maybe_f32", "maybe_i16", "maybe_i32", "maybe_i64", "maybe_i8"]}},
  "optional_scalars_defaults" =>
    {:error, :mismatch,
     {:keys_diff, [], [],
      ["maybe_bool", "maybe_f32", "maybe_i16", "maybe_i32", "maybe_i64", "maybe_i8"]}},
  "test_64bit" =>
  ...
  "unicode_test" => :ok,
  "unicode_test_ts" => :ok,
  "union_vector" => {:error, :mismatch, {:keys_diff, [], [], ["characters_type"]}}
}
